...
export default function SignupPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center p-4 bg-[#07090e] overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] bg-gradient-to-r from-purple-600/15 via-indigo-600/15 to-transparent rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-white/[0.08] bg-[#0c101d]/90 p-8 shadow-2xl backdrop-blur-xl">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">
            Get started with AI Codebase Intelligence &amp; RAG Chat
          </p>
        </div>
